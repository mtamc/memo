...
const entries = JSON.parse(fs.readFileSync('./converted_towatch1.json'))

const stream = fs.createWriteStream("converted_towatch2.json", {flags:'a'});
const stream2 = fs.createWriteStream("failed_indices_towatch", {flags:'a'});
